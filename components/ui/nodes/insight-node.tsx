...
export default function InsightNode({ data }: { data: NodeProps }) {
    ...
    return (
        <div className="box-border h-[400px] rounded-3xl border border-[#E4E4E4] md:h-[350px] lg:col-span-3 lg:h-full">
