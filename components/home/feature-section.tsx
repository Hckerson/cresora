...
export default function Features() {
  ...
  return (
    <div className={clsx("paddy xs:flex flex-col gap-y-16 hidden py-[144px]", geist.className)}>
      <div className="box-border flex flex-col items-center xl:flex-row xl:justify-between">
        ...
        <div className="flex flex-1 justify-end pt-4 xl:px-0 xl:pt-0">
          <p className="text-primary-foreground xs:text-start max-w-[630px] px-6 text-center text-sm xl:w-[40ch] xl:px-0">
            Explore the tools that help founders, operators, and teams manage
            money with confidence from cash tracking to budget controls
          </p>
        </div>
      </div>
      <div className="box-border grid w-full grid-cols-1 gap-x-8 lg:grid-cols-2">
        ...
        <div className="bg-background relative box-border overflow-hidden flex h-full w-full items-center justify-center  border border-[#dadcdf] rounded-3xl">
          <CustomImage
